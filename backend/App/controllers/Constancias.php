        ...
        foreach (GeneralDao::getAllUsuariosTalleres($id_producto) as $key => $value) {
            ...
            <tr>
              <td>
                    <div class="d-flex px-1 py-1">
                        <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm text-black"><span class="fa fa-user" style="font-size: 13px"></span>{$value['name_user']} {$value['middle_name']} {$value['surname']} {$value['second_surname']}</h6>
                        </div>
                    </div>
                </td>
